...
# URL da API
url_media_notas = "http://localhost:8079/apiDados/mediaNotas"
...
try:
    ...
    if isinstance(data, list) and len(data) > 0:
        porcentagens = [int(item.get("PORCENTAGEM_CONCLUIDO", 0)) for item in data]
    else:
    ...
    plt.xticks(range(0, 101, 10))  # Marcas no eixo X ajustadas para intervalos de 10
